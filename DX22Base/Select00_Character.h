...
private:
	...
	//=======<後ろのボードに関する情報>=====================================================================
	BOARDCOLOR				m_BordColorType = BOARDCOLOR::MAX;
	Image2D					m_CharacterUnconnectBoardImage;			//キャラクターセレクトの後ろにあるボード
	Image2D					m_CharacterConnectBoardImage;			//キャラクターセレクトの後ろにあるボード
